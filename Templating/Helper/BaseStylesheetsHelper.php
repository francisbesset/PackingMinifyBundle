 ...
 */
class BaseStylesheetsHelper extends Helper
{
     ...
     * Constructor.
     *
     * @param BaseAssetsHelper $assetHelper A AssetsHelper instance
     */
    public function __construct(BaseAssetsHelper $assetHelper)
    {
